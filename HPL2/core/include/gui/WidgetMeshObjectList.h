...
/*
class cEditorObjectList : public iWidget, public iWidgetItemContainer
{
public:
	cEditorObjectList(cEditorWindowObjectBrowser* apBrowser, cGuiSet* apSet, cGuiSkin* apSkin);
	~cEditorObjectList();
...
protected:
	...
	cEditorWindowObjectBrowser* mpBrowser;
};
*/
